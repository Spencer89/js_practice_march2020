...
/*Create a new, empty array. Loop through all of the words. 
The iteration of the new array will be the same as the word iteration, when they have
been put through the function reverseWords*/
...
/*Set a count for the number of Linux users. Loop through all of the users.
if the type of user is the same as "Linux", add one to the count. return count */
...
function getMeanScore(scores) {
  ...
  let summation = scores.reduce((accumulator, currentValue) => { return accumulator + currentValue })
